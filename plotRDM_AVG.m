...
sumMat_MT_unt = zeros(4);
sumMat_SM_unt = zeros(4);
sumMat_MT_t = zeros(4);
sumMat_SM_t = zeros(4);

% LEAVE P6 OUT TO CORRECT LATER
for ii = 1:5
% MT UNTRAINED
...
meanMat_MT_unt = sumMat_MT_unt / 5;
meanMat_SM_unt = sumMat_SM_unt / 5;
meanMat_MT_t = sumMat_MT_t / 5;
meanMat_SM_t = sumMat_SM_t / 5;
